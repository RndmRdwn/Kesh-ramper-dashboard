  ...
  return (
    <div className='flex flex-col gap-1 '>
        <div className='flex flex-col gap-2'>
            ...
            <Button className='w-fit px-8 py-5 text-sm' onClick={handleVerify}  variant='outline'>Verify now</Button>
        </div>
        <p className='text-muted-foreground text-xs lg:pr-8'>You must verify your phone number via SMS to process payments from the Dashboard. Your number will not be publicly displayed.</p>
